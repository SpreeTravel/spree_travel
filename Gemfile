...
# gem 'spree_travel_hotel', :git => 'file:///Volumes/Data/Important/spree_travel/openjaf/spree_travel_hotel', :branch => '2-4-stable'
gem 'spree_travel_hotel', :git => "https://github.com/openjaf/spree_travel_hotel", :branch => '2-4-stable'
...
# gem 'spree_travel_flight', :git => 'file:///Volumes/Data/Important/spree_travel/openjaf/spree_travel_flight', :branch => '2-4-stable'
# gem 'spree_travel_flight', :path => "../spree_travel_flight"
gem 'spree_travel_flight', :git => "https://github.com/openjaf/spree_travel_flight", :branch => '2-4-stable'
